...
app.get('/', (req, res) => res.send('This bot was been maded by VINCENT 444#8079'))
...
client.on("ready", async () => {
  console.log(`Moderation.with.vincent has been deployed!! 🚀 Coded by VINCENT 444#8079`);
  client.user
    .setActivity(`VINCENT 444#8079`, { type: "LISTENING" })
...
//Bot Coded by VINCENT 444#8079 (Aditya Singh) DONOT share WITHOUT credits!!
